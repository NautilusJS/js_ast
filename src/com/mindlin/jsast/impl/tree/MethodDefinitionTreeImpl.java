...
public class MethodDefinitionTreeImpl extends ClassPropertyTreeImpl<FunctionExpressionTree> implements MethodDefinitionTree {
	...
	public MethodDefinitionTreeImpl(long start, long end, Modifiers modifiers, PropertyDeclarationType declaration, ObjectPropertyKeyTree key, TypeTree type, FunctionExpressionTree value) {
