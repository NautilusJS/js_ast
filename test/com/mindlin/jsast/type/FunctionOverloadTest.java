...
public class FunctionOverloadTest {
	...
	public Set<Signature> getSimpleOverrideList() {
		...
		ParameterInfo x = new ParameterInfo(null, new IdentifierTreeImpl(null, null, "x"), false, false, IntrinsicType.NUMBER, null);
		Signature f1 = new SignatureImpl(Collections.emptyList(), Arrays.asList(x), IntrinsicType.NUMBER);
		
		//function f(y: string): string
		ParameterInfo y = new ParameterInfo(null, new IdentifierTreeImpl(null, null, "y"), false, false, IntrinsicType.STRING, null);
		Signature f2 = new SignatureImpl(Collections.emptyList(), Arrays.asList(y), IntrinsicType.STRING);
		
		ParameterInfo z = new ParameterInfo(null, new IdentifierTreeImpl(null, null, "z"), false, false, CompositeType.union(IntrinsicType.STRING, IntrinsicType.NUMBER), null);
